...
// For the internal registers each clock cycle is oversampled by a factor of 128 
// (don’t worry about exactly how) meaning that the internal clock registers that track 
// transmit and receive time are working in time units of 1/128th of a clock cycle. 
// So that the internal time registers are counting at a rate of 128*499.2e6 MHz 
// giving a tick period of around 15e-12 s or 15 ps.
